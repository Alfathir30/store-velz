...
function openPurchaseModal() {
  ...
  // Reset semua form groups
  document.getElementById("accountInfoGroup").style.display = "none"
  document.getElementById("apkCredentialsGroup").style.display = "none"
  document.getElementById("deliveryContactGroup").style.display = "none"

  // Show form berdasarkan jenis produk
  if (selectedProduct.type === "followers" || selectedProduct.id.includes("bug")) {
    document.getElementById("accountInfoGroup").style.display = "block"
  }

  // Show APK credentials form untuk APK Premium
  if (selectedProduct.id.includes("apk-") && !selectedProduct.id.includes("virus")) {
    document.getElementById("apkCredentialsGroup").style.display = "block"
  }

  // Show delivery contact form untuk Surxrat dan APK Hack
  if (selectedProduct.id.includes("virus") || selectedProduct.id === "surxrat") {
    document.getElementById("deliveryContactGroup").style.display = "block"
  }
...
function clearPurchaseForm() {
  ...
  document.getElementById("apkEmail").value = ""
  document.getElementById("apkPassword").value = ""
...
async function processPurchase() {
  ...
  // Validasi untuk APK Premium
  if (selectedProduct.id.includes("apk-") && !selectedProduct.id.includes("virus")) {
    if (!apkEmail || !apkPassword) {
      alert("Mohon lengkapi email dan password untuk akun premium!")
      return
    }
  }

  // Validasi untuk APK Hack/Surxrat
  if (selectedProduct.id.includes("virus") || selectedProduct.id === "surxrat") {
    if (!deliveryMethod || !deliveryContact) {
